...
import com.aphaulage.apfleettracker.JobDetailsActivity.CollectionDetailsFragment;
import com.aphaulage.apfleettracker.JobDetailsActivity.DropoffDetailsFragment;
import com.aphaulage.apfleettracker.JobDetailsActivity.JobDetailsFragment;
import com.aphaulage.apfleettracker.JobDetailsActivity.PackageDetailsFragment;
import com.aphaulage.apfleettracker.JobDetailsActivity.VehicleDetailsFragment;
...
public class ActiveJobDetailsActivity extends FragmentActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.active_job_details, menu);
		return true;
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fm) {
			...
			jobPackagesDB.open();
			Log.i("job id:", jobId);
			jobsCursor = jobsDB.getJob(jobId);
			collection_id = jobsCursor.getString(2);
			dropoff_id = jobsCursor.getString(3);
			
			vehicleId = jobsCursor.getString(10);
			Cursor jobPackagesCursor = jobPackagesDB.getJobPackagesByJob(jobId);

			packages_count = Integer.toString(jobPackagesCursor.getCount());
			jobPackagesDB.open();
			jobsDB.close();
		}
		...
		public Fragment getItem(int position) {
			...
			switch(position){
				...
				case 3:
					...
					vehiclesDB.open();
					vehiclesCursor = vehiclesDB.getVehicle(vehicleId);
